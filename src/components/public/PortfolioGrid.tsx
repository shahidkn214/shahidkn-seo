...
export function PortfolioGrid({ projects }: { projects?: ProjectData[] }) {
  ...
  return (
    <section id="portfolio" className="border-b border-border dark:border-neutral-800 bg-background dark:bg-[#0a0a0a]">
      ...
      <div className="py-12 sm:py-20">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-2xl mb-8 sm:mb-12">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-text dark:text-white tracking-tight mb-3">
              Selected SEO &amp; Editorial Work
            </h2>
            <p className="text-text-dim dark:text-gray-400 text-sm sm:text-base leading-relaxed">
              ...
              return (
                <Link
                  ...
                  className={`group flex flex-col justify-between p-5 sm:p-6 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-1 cursor-pointer ${
                    isDistinct
                      ? "bg-bg-alt dark:bg-neutral-900 border-2 border-red/40 hover:border-red"
                      : "bg-card dark:bg-[#14161f] border border-border dark:border-neutral-800 hover:border-red/30"
                  }`}
                >
                  <div>
                    {/* AEO / GEO Badges */}
                    ...
                    {/* Article Title */}
                    <h3 className="font-serif text-lg sm:text-xl font-semibold text-text dark:text-white leading-snug group-hover:text-red transition-colors mb-2.5">
                      {article.title}
                    </h3>

                    {/* Description for distinct card */}
                    {article.description && (
                      <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed mb-4">
                        {article.description}
                      </p>
                    )}
                    ...
                    {article.metrics && (
                      <div className="mt-4 pt-3.5 border-t border-border dark:border-neutral-800 grid grid-cols-2 gap-2 bg-bg-alt/60 dark:bg-neutral-900/60 p-2.5 rounded-lg border border-border/60 dark:border-neutral-800">
                        <div>
                          <span className="block text-[10px] font-medium text-text-dim dark:text-gray-400 uppercase tracking-wider">
                            Content Score
                          </span>
                  ...
                  {/* Card Action Link */}
                  <div className="pt-4 mt-4 border-t border-border dark:border-neutral-800 flex items-center justify-between text-xs font-medium text-text-dim dark:text-gray-400 group-hover:text-text dark:group-hover:text-white transition-colors">
                    <span>
      ...
      <div className="py-16 bg-card/20 dark:bg-neutral-900/20 border-t border-border dark:border-neutral-800 w-full">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          {/* Section Header Group */}
          <div className="max-w-2xl text-left">
            <h3 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight text-text dark:text-white mb-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 mt-8">
            {SEO_TOOLS_TECH_STACK.map((tool) => (
              <div
                key={tool.name}
                className="bg-card dark:bg-[#14161f] border border-border/60 dark:border-neutral-800 rounded-xl p-4 flex flex-col items-center text-center shadow-sm hover:border-red/40 transition-all duration-200 group"
              >
                {/* Icon Stack */}
                <div className="w-10 h-10 rounded-lg bg-bg-alt dark:bg-neutral-900 flex items-center justify-center transition-transform group-hover:scale-110">
                  {tool.icon}
                </div>

                {/* Tool Name */}
                <span className="text-sm font-medium text-text dark:text-white mt-2">
                  {tool.name}
                </span>

                {/* Context Sub-label */}
                <span className="text-[11px] text-text-dim dark:text-gray-400 mt-1 leading-tight">
                  {tool.context}
                </span>
              </div>
            ))}
      ...
      <div className="py-16 bg-background dark:bg-[#0a0a0a] border-t border-border dark:border-neutral-800 w-full">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          {/* Section Header Group */}
          <div className="max-w-2xl text-left">
            <h3 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight text-text dark:text-white mb-2">
          ...
          <div className="flex flex-col gap-8 mt-8">
            {CASE_STUDIES.map((cs, index) => (
              <div
                key={cs.id}
                className="bg-card dark:bg-[#14161f] border border-border dark:border-neutral-800 rounded-xl p-6 md:p-8 flex flex-col gap-4 transition-all duration-200 hover:border-red/30 shadow-sm"
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div>
                    ...
                    <h4 className="font-serif text-lg sm:text-xl font-bold text-text dark:text-white mt-0.5">
                      {cs.context}
                    </h4>
                  </div>
                  <span className="text-xs font-mono font-medium px-2.5 py-1 rounded bg-bg-alt dark:bg-neutral-900 text-text-dim dark:text-gray-400 border border-border dark:border-neutral-800 w-fit">
                    {cs.tag}
                  </span>
                </div>

                {/* Internal Interactive Columns: Problem, Strategy, Result */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-border/60 dark:border-neutral-800">
                  {/* Problem Column */}
                  <div className="flex flex-col">
                    ...
                    <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed">
                      {cs.problem}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed mt-1">
                      {cs.resultDetails}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            {PROGRAMMATIC_PIPELINES.map((pipe) => (
              <div
                key={pipe.id}
                className="bg-card dark:bg-[#14161f] border border-border dark:border-neutral-800 rounded-xl p-6 flex flex-col gap-3 transition-all duration-200 hover:border-red/40 shadow-sm"
              >
                {/* Header Row: Title & Badges */}
                <div className="flex flex-col gap-2">
                  <h4 className="font-serif text-lg sm:text-xl font-semibold text-text dark:text-white">
                    {pipe.title}
                  </h4>
                  <div className="flex flex-wrap items-center gap-1.5">
                    {pipe.badges.map((badge) => (
                      <span
                        key={badge}
                        className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-bg-alt dark:bg-neutral-900 text-text-dim dark:text-gray-400 border border-border/60 dark:border-neutral-800"
                      >
                        {badge}
                      </span>
                    ))}
                ...
                <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed pt-2 border-t border-border/60 dark:border-neutral-800">
                  {pipe.description}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          <div id="technical-seo">
            <div className="max-w-2xl mb-8 sm:mb-10">
              ...
              <h3 className="font-serif text-2xl sm:text-3xl font-bold text-text dark:text-white mt-1.5 mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              {TECHNICAL_SEO_CAPABILITIES.map((cap) => (
                <div
                  key={cap.title}
                  className="p-5 sm:p-6 bg-card dark:bg-[#14161f] border border-border dark:border-neutral-800 rounded-xl flex flex-col justify-between hover:border-red/30 transition-colors last:sm:col-span-2"
                >
                  <div>
                    ...
                    <h4 className="font-serif text-lg font-semibold text-text dark:text-white mb-2">
                      {cap.title}
                    </h4>
                    <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed">
                      {cap.description}
      ...
      <div id="contact" className="py-16 bg-background dark:bg-[#0a0a0a] border-t border-border dark:border-neutral-800 w-full">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          {/* Section Header Group */}
          ...
          {/* Form Layout Grid */}
          {formSubmitted ? (
            <div className="max-w-xl mx-auto p-6 sm:p-8 bg-card dark:bg-[#1c1c1c] border border-emerald/30 rounded-xl text-center shadow-md animate-in fade-in duration-300">
              ...
              <h4 className="font-serif text-xl font-bold text-text dark:text-white mb-2">
                Audit Request Submitted!
              </h4>
              <p className="text-text-dim dark:text-gray-400 text-sm leading-relaxed mb-6">
      ...
      <footer className="w-full bg-card dark:bg-[#11131a] border-t border-border/80 dark:border-neutral-800 pt-12 pb-8 px-4 sm:px-6 mt-16">
        <div className="max-w-[1100px] mx-auto">
          {/* Responsive 3-Column Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Column 1: Brand Identity */}
            <div>
              <h4 className="font-serif text-lg font-bold text-text dark:text-white mb-2">
                Shahid KN
              </h4>
              <p className="text-text-dim dark:text-gray-400 text-xs sm:text-sm leading-relaxed max-w-sm">
            ...
            <div>
              <h5 className="font-serif text-sm font-semibold text-text dark:text-white uppercase tracking-wider mb-3">
                Trust &amp; Legal
              </h5>
              <ul className="flex flex-col gap-2 text-xs sm:text-sm text-text-dim dark:text-gray-400">
                <li>
                  <Link href="/about" className="hover:text-text dark:hover:text-white transition-colors">
                    About Layout
                  </Link>
                </li>
                <li>
                  <Link href="/privacy" className="hover:text-text dark:hover:text-white transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className="hover:text-text dark:hover:text-white transition-colors">
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link href="/cookies" className="hover:text-text dark:hover:text-white transition-colors">
                    Cookies Configuration
                  </Link>
                </li>
                <li>
                  <Link href="/disclosure" className="hover:text-text dark:hover:text-white transition-colors">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs sm:text-sm text-text-dim dark:text-gray-400 transition-colors hover:text-red dark:hover:text-red w-fit"
                >
